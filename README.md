...
| parser.uni | 58.2KB | `uni-app` 插件包（可以编译到所有平台） |
...
## 更新日志 ##
- 2020.3.26  
  1. `F` 修复了使用自闭合 `svg` 标签会导致死循环的问题 [详细](https://github.com/jin-yufeng/Parser/issues/94)  
  2. `F` 修复了设置 `domain` 属性时 `data:image` 和 `cloud://` 的链接会被错误填充的问题  
